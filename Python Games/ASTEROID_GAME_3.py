...
spaceship = pygame.image.load('tiefighter.png')
...
def detect_asteroid_collision(player_posi, asteroid_posi):
        px = player_posi[0]
        py = player_posi[1]
...
while not game_over:
        ...
        if asteroid_collision_check(asteroid_total, player_posi):
                game_over = True
